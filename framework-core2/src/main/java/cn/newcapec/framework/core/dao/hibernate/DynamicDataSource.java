  ...
  implements ApplicationContextAware
{
    ...
    throws PropertyVetoException
  {
    ...
    ComboPooledDataSource parent = (ComboPooledDataSource)this.ctx.getBean("parentDataSource");
    ...
    throws PropertyVetoException
  {
    ...
    try {
      conn = getConnection();
      PreparedStatement ps = conn.prepareStatement("select * from t_data_source  where tenant_id=?");
    ...
    if (null != map) {
      ...
      ComboPooledDataSource dataSource = createDataSource(driverClassName, url, userName, password);
