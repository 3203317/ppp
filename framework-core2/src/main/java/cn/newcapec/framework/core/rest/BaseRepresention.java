...
public class BaseRepresention extends StringRepresentation
{
  ...
  {
    super(message.toJSONObject().toString(), MediaType.TEXT_PLAIN, null, CharacterSet.UTF_8);
  }

  public BaseRepresention(boolean flag, String msg)
  {
    super(new Msg(flag, msg).toJSONObject().toString(), MediaType.TEXT_PLAIN, null, CharacterSet.UTF_8);
  }

  public BaseRepresention(boolean flag, String msg, Object data)
  {
    super(new Msg(flag, msg, data).toJSONObject().toString(), MediaType.TEXT_PLAIN, null, CharacterSet.UTF_8);
  }

  public BaseRepresention(String msg, Object data)
  {
    super(new Msg(true, msg).setData(data).toJSONObject().toString(), MediaType.TEXT_PLAIN, null, CharacterSet.UTF_8);
  }
  ...
  {
    super(new Msg().setData(map).toJSONObject().toString(), MediaType.TEXT_PLAIN, null, CharacterSet.UTF_8);
  }

  public BaseRepresention(Variant variant)
  {
    super(new Msg().setData(variant).toJSONObject().toString(), MediaType.TEXT_PLAIN, null, CharacterSet.UTF_8);
  }

  public BaseRepresention(Object data)
  {
    super(new Msg().setData(data).toJSONObject().toString(), MediaType.TEXT_PLAIN, null, CharacterSet.UTF_8);
  }
