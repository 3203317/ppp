...
public abstract class DirectiveUtil {
	...
	public static String getString(String name, Map<String, TemplateModel> params) {
		...
		try {
			if (model instanceof TemplateScalarModel) {
				...
				string = ((TemplateNumberModel) model).getAsNumber().toString();
			} else {
				return null;
			}
		} catch (Exception e) {
	...
	public static Date getDate(String name, Map<String, TemplateModel> params) throws Exception {
		TemplateModel model = params.get(name);
		if (model == null) {
			return null;
		}
	 ...
	 * @throws TemplateException
	 */
	public static Integer getCount(Map<String, TemplateModel> params) throws TemplateException {
		Integer count;
		try {
			count = getInt(COUNT, params);
