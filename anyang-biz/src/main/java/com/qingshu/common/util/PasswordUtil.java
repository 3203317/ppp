...
public class PasswordUtil {
	...
	public static final String Salt = "hnjsjpsy";//8位字符密钥
...
//		ReflectHelper reflectHelper=new ReflectHelper(JGCompany.class);
//		System.out.print(reflectHelper.obj.getClass().getName());
		int i=10;
		for (int j = 0; j < i; j++) {
			if((j)%3==0)
			{
