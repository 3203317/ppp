package net.foreworld.framework.core.utils.fileUtils.fileloader;

import net.foreworld.framework.core.utils.clazzUtils.ClassLoaderUtils;
...
public final class FileLoaderFactory {
	 ...
	 * 默认的文件资源载入类
	 */
	private static String DEFAULT_FILE_LOADER = "net.foreworld.framework.utils.fileloader.DefaultFileLoader";
