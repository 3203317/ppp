...
public class HttpTransilinkContext extends AbstractTransilinkContext
{
  ...
  public void setRequest(HttpServletRequest httpservletrequest)
  {
    ...
    {
      Reference reference;
      if (((reference = (Reference)this.reqeustStack.get(j)) != null) && (reference.get() == httpservletrequest))
      {
        flag = true;
        for (int k = i - 1; k > j; k--) {
  ...
  public Object getAttribute(int i, String s)
  {
    ...
    case 9:
      return httpservletrequest.getSession().getServletContext().getAttribute(s);
    case 2:
    case 3:
    case 4:
    case 6:
  ...
  public void setAttribute(int i, String s, Object obj)
  {
    ...
    case 5:
      ...
      return;
    case 9:
      httpservletrequest.getSession().getServletContext().setAttribute(s, obj);
    case 2:
    case 3:
    case 4:
    case 6:
  ...
  public void removeAttribute(int i, String s)
  {
    ...
    case 5:
      ...
      return;
    case 9:
      httpservletrequest.getSession().getServletContext().removeAttribute(s);
    }
  }
}