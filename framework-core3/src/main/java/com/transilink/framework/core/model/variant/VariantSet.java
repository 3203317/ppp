  ...
  implements Serializable, Cloneable
{
  ...
  {
    int j = 0; for (int len = variantSet.count(); j < len; j++) {
    ...
    throws CloneNotSupportedException
  {
    ...
    int i = 0; for (int len = this.data.size(); i < len; i++)
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer(ClassUtils.getShortClassName(super.getClass())).append(":").append(this.data.toString());
